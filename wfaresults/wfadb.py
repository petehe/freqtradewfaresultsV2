    ...
    def addrecordsfromfile(self, resultfilename):
        ...
        try:
            ...
            for index, row in resultdf.iterrows():
                ...
                insert_sql = (
                    'INSERT INTO "main"."wfaresultsV2" ("Type","Strategy", "Market", "MaxTrades", "timeframe", "epoch","IS_Start","IS_End", "HOReturn", "HOSharpeRatio", "HOWinRate",'
                    ...
                    + "VALUES"
                    + f"('{type}','{strategy}', '{market}', '{maxtrades}', '{timeframe}', '{epoch}', '{IS_Start}','{IS_End}', '{HO_return}', '{HO_Sharpe}', '{HO_WinRate}', "
